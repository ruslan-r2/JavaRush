...
public class Solution {
    public static void main(String[] args) {
        ...
        Man man1 = new Man("Вася", 21, "Petlura_street");
        Man man2 = new Man("Petia", 21, "Bulgakov_street");
        System.out.println( man1.name + " " + man1.age + " " + man1.address );
        System.out.println( man2.name + " " + man2.age + " " + man2.address );

        Woman woman1 = new Woman("Olesia", 22, "Petlura_street");
        Woman woman2 = new Woman("Irina", 20, "Bulgakov_street");
