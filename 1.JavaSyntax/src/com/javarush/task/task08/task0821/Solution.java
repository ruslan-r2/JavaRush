...
public class Solution {
    ...
    public static Map<String, String> createPeopleList() {
        ...
        people.put("Бурков","Иван");
        people.put("Бурэ","Александр");
        people.put("Овечкин","Александр");
        people.put("Синицин","Андрей");
        people.put("Сталоне","Андрей");
        people.put("Путин","Владимир");
        people.put("Медведев","Дмитрий");
        people.put("Лопата","Василий");
        people.put("Бурков","Слава");
